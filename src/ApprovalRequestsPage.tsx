...
function ApprovalRequestsPageComponent({
  prefetchedData,
  initialFilter,
    ...
    sortField === null
      ...
      : [...filteredRequests].sort((a, b) => {
          ...
          if (sortField === "number")
            ...
            cmp = (a.requestedDuration ?? "").localeCompare(
              b.requestedDuration ?? "",
            );
          else if (sortField === "productNumber")
            cmp = ((a.qtId ?? 0) as number) - ((b.qtId ?? 0) as number);
          else if (sortField === "lockerNumber")
            cmp = (a.locker ?? "").localeCompare(b.locker ?? "");
  ...
  return (
    ...
    >
      <Box
        ...
        sx={{ width: "100%", maxWidth: "100%", px: { xs: 1, sm: 2 } }}
      >
              ...
              {(
                ...
                <MenuItem
                  ...
                  sx={{
                    gap: 0.5,
                    color: "var(--text)",
                    "&:hover": { background: "rgba(24,119,242,0.08)" },
                  }}
                >
                  <Checkbox
                    checked={colVisibility[key]}
                    size="small"
                    sx={{ p: 0.5, color: "#b4d7ff" }}
                  />
                ...
                >
                  <TableRow>
                    {[
                      ...
                      {
                        field: "description" as SortField,
                      ...
                      <TableCell
                        key={col.field}
                        sx={{ padding: largeCellPadding, width: col.width }}
                      >
                        <TableSortLabel
                    ...
                    {colVisibility.date && (
                      <TableCell
                        sx={{ padding: largeCellPadding, width: "12%" }}
                      >
                        <TableSortLabel
                    ...
                    {colVisibility.duration && (
                      <TableCell
                        sx={{ padding: largeCellPadding, width: "8%" }}
                      >
                        <TableSortLabel
                          active={sortField === "duration"}
                          direction={sortField === "duration" ? sortDir : "asc"}
                    ...
                    {colVisibility.productNumber && (
                      ...
                      >
                        <TableSortLabel
                          active={sortField === "productNumber"}
                          direction={
                            sortField === "productNumber" ? sortDir : "asc"
                          }
                    ...
                    {colVisibility.lockerNumber && (
                      <TableCell
                        sx={{ padding: largeCellPadding, width: "10%" }}
                      >
                        <TableSortLabel
                          active={sortField === "lockerNumber"}
                          direction={
                            sortField === "lockerNumber" ? sortDir : "asc"
                          }
                          onClick={() => handleSort("lockerNumber")}
                          sx={{
                            color: "inherit",
                            "& .MuiTableSortLabel-icon": {
                              color: "inherit !important",
                      ...
                      <TableCell sx={{ padding: largeCellPadding }}>
                        {(() => {
                          ...
                          if (s === "pending") {
                            ...
                            s.includes("returninit") ||
                            s.includes("return init")
                          ) {
                            bg = "#6366f1";
                            color = "#fff";
...
const ApprovalRequestsPage = ApprovalRequestsPageComponent;
